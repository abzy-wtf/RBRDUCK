...
The Richard Burns Rally co-Driver Universal Creation Kit (RBRDUCK) is an SDK-like tool that allows an end-user to quickly and conveniently record their own custom co-driver calls for Richard Burns Rally in a Luppis/JanneMod V3 framework.
...
2. **Download the Current Release:** Download the latest release of RBRDUCK from the [releases page](https://github.com/abzy-wtf/RBRDUCK/releases) to the newly-created Tools folder.
